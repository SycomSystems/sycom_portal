...
# Only update the sklad page - API routes are fine
path = 'src/app/(admin)/admin/sklad/page.tsx'
...
print('Done! Run: git add -A && git commit -m "Fix sklad: centering + goods autocomplete with new item creation" && git push')
print('Then: npm run build && pm2 restart sycom-portal')
