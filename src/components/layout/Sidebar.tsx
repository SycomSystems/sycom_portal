...
import {
  ...
  Settings, Phone, Building2, Package, FileText, Bug, ClipboardList, ShoppingCart, Receipt, ScanText
} from 'lucide-react'
...
const navItems: NavItem[] = [
  ...
  { href: '/faktury', label: 'Faktúry', icon: <Receipt size={16} />, roles: ['ADMIN', 'AGENT'] },
  { href: '/admin/invoice-ocr', label: 'Invoice OCR', icon: <ScanText size={16} />, roles: ['ADMIN'] },
