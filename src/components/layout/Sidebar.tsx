...
import {
  ...
  Settings, Phone, Building2, Package, FileText, Bug, ClipboardList, ShoppingCart, Receipt
} from 'lucide-react'
...
const navItems: NavItem[] = [
  ...
  { href: '/admin/kb', label: 'Knowledge base', icon: <BookOpen size={16} />, roles: ['ADMIN', 'AGENT'] },
  ...
  { href: '/faktury', label: 'Faktúry', icon: <Receipt size={16} />, roles: ['ADMIN'] },
