...
path = '/opt/sycom-portal/src/app/(admin)/admin/reports/vykaz/page.tsx'
          ...
          <div ref={printRef} id="vykaz-print">
            ...
            <div className="bg-white border border-gray-200 rounded-2xl overflow-hidden">
              ...
              <div className="overflow-x-auto"><table className="w-full text-sm">
                ...
                {sortedGoods.length>0&&(<tfoot><tr className="border-t-2 border-gray-200 bg-gray-50"><td colSpan={4} className="px-4 py-2.5 text-xs font-bold text-gray-500">Spolu tovar</td><td className="px-4 py-2.5 text-xs font-bold text-blue-600">{fmt(summary.totalGoodsPrice)} EUR</td><td colSpan={2}/></tr></tfoot>)}
              </table></div>
            </div>
